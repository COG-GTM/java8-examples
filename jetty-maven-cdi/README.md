...
+ Jetty 11.0.20 (Jakarta EE 9, Servlet 5.0)
...
+ Add `org.jboss.weld.servlet:weld-servlet-shaded:4.0.3.Final` as a dependency for
`jetty-maven-plugin`
...
+ Jetty 11.x targets Jakarta EE 9 (`jakarta.*` namespace) and requires Weld 4.x (CDI 3.0)
